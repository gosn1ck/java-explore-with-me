...
public class AdminCategoryController {
    ...
    public ResponseEntity<CategoryResponse> add(@RequestBody CategoryDto dto) {
    ...
    public ResponseEntity<CategoryResponse> update(@RequestBody CategoryDto dto, @PathVariable("catId") Long id) {
